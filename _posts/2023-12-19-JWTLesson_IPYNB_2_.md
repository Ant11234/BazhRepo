...
layout: post
title: JWT Lesson
description: by Emma, Vivian, Grace, Aliya, Kevin, Isabelle
courses: {'csa': {'week': 18}}
type: ccc
---
...
- header: Identifies the token's type and the algorithm used for signing
- payload: Contains the claims or statements about the user and additional data
- signature: A security component created by encoding the header, payload, and a secret, ensuring the token's integrity
- algorithm: The method used to generate the signature, like HS256 or RS256
- secret key: A confidential key used by the signing algorithm to create the signature, known only to the issuer and validator of the JWT
...
<img width="1279" alt="Screenshot 2024-01-09 at 12 42 44 AM" src="https://github.com/Ant11234/student/assets/40652645/513be336-10dd-4285-bd2c-a66622519e3b">

...
- Private variables can only be accessed within the class and public can be accessed from anywhere.
...
public class Animal {
    ...
    public void move() {
        System.out.println("The " + species.toLowerCase() + " runs at " + milesPerHour + " miles per hour.");
    }
...
public class Aardvark extends Animal {
    ...
    public Aardvark(String species, int milesPerHour, int tongueLength) {
    ...
    @Override
    public void move() {
        System.out.println("The " + getSpecies().toLowerCase() + " has a " + tongueLength + " inch long tongue and moves at " + getMilesPerHour() + " miles per hour.");
    }
}

public class Main {
    public static void main(String[] args) {
        Aardvark aardvark = new Aardvark("Aardvark", 5, 12);
        aardvark.move();
    }
}
...
```
    ...
    The aardvark has a 12 inch long tongue and moves at 5 miles per hour.
...
public class ElectronicDevice {
    ...
    public void displayInfo() {
        System.out.println("The " + brand + " is priced at $" + price);
    }
}
...
public class Smartphone extends ElectronicDevice {
    ...
    public void displayInfo() {
        super.displayInfo();
        System.out.println("It runs on the " + operatingSystem + " operating system.");
    }
}
...
public class Laptop extends ElectronicDevice {
    ...
    public Laptop(String brand, double price, String processor, int memory) {
        super(brand, price);
    ...
    public void displayInfo() {
        super.displayInfo();
        System.out.println("It features a " + processor + " processor and " + memory + "GB of memory.");
    }
}

public class Main {
    public static void main(String[] args) {
        ElectronicDevice device1 = new Smartphone("Apple iPhone", 999.99, "iOS");
        ElectronicDevice device2 = new Laptop("Dell XPS", 1299.99, "Intel Core i7", 16);
...
```
    ...
    Smartphone Info:
    The Apple iPhone is priced at $999.99
    It runs on the iOS operating system.
    
    Laptop Info:
    The Dell XPS is priced at $1299.99
    It features a Intel Core i7 processor and 16GB of memory.
...
1. Define each of the following terms in your own words
 - **Downcasting** - Casting an object reference to a subclass from superclass.
 - **Static Type** - A variable that cannot change during the program’s execution.
 - **Dynamic Type** - A variable that can be changed during program's execution.
 - **Polymorphism** - Allows objects of different classesto be trated as objects of common superclass.
...
```
    ...
    REPL.$JShell$40M$Person@14c9b363
...
public class Car extends Vehicle {
    ...
    public Car(String make, int year, String bodyType) {
        super(make, year);
...
public class Motorcycle extends Vehicle {
    ...
    public Motorcycle(String make, int year, String style) {
        super(make, year);
        this.style = style;
    }
    ...
    public void ride() {
        System.out.println("Riding the " + getMake());
    }
}
...
public class Main {
    public static void main(String[] args) {
        ...
        Motorcycle motorcycle = new Motorcycle("Harley-Davidson Sportster", 2023, "Cruiser");
...
<img src='https://github.com/Ant11234/student/assets/40652645/0ddaa710-7623-4a68-ab6b-3e31b0878a86'>
